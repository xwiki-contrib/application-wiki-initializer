...
/**
 * Exception specific to the wiki initializer module.
 *
 * @version $Id$
 * @since 1.2.0
 */
public class WikiInitializationException extends Exception
{
    /**
     * Construct a new WikiInitializationException.
